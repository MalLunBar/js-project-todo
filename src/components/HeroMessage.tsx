  ...
  return (
    <div>
      ...
      <div className="flex flex-col-reverse py-10 px-12 sm:py-24 sm:px-20 max-w-[400px] sm:max-w-[500px] md:max-w-[600px] m-auto mx-auto lg:min-w-[500px] lg:px-12 lg:py-40">
        <h1 className="font-medium text-3xl sm:text-5xl md:text-6xl">From Clutter to <span className="text-[#FFBB00] bg-gray-300 px-[3px] rounded-4xl">Done</span> with Done-ly</h1>
